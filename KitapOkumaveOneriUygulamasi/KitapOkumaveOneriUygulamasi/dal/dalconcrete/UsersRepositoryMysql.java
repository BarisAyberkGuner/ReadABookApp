...
public class UsersRepositoryMysql implements IUsersRepository {
	...
	public boolean UyeOlma(Users entity) {
		try {
			String UyeEkleme = "insert into yazilimlab.bx_users" + "(location,age,password)" + "values(?,?,?,?)";
			PreparedStatement psmt = baglanti.prepareStatement(UyeEkleme);
			psmt.setString(1, entity.getLocation());
			psmt.setString(2, entity.getAge());
			psmt.setString(3, entity.getPassword());
